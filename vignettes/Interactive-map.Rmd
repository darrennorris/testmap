...
in the future (25 and 75% quantiles: `r q25_value` - `r q75_value`.
...
by country and major basin. Results include the size and extent of likely
...
bind_rows(table_country_ffr, sumrow_ffr) |> 
  select(COUNTRY, pop_change, prop_end, length_river) |>
...
table_basin_ffr |> 
  select(BASIN_NAME, pop_change, prop_end, length_river) |>
...
tab_sum |> 
  ...
  droplevels() |>
  select(BASIN_NAME, COUNTRY, pop_change, proportion_endangered, 
         length_river) |> 
