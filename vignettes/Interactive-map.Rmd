...
Columns show predicted population changes for each basin country combination \@ref(fig:fig-basin-country-ffr).
...
The labels above each column show river lengths in thousands of 
