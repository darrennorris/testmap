...
### River points Norris 2019
Map below uses the river points from 
...
```{r make-table-country, echo=FALSE, eval=FALSE}
# This throws an error when checked. Vignette wont build.
...
knitr::kable(col.names = c("Country", "Endangered (prop)","river length (km)", 
  ...
  kableExtra::column_spec(2:9, width = "2.5cm")
