...
```{r fig-basin-country-ffr, echo=FALSE, message=FALSE, warning=FALSE}
# Plot
...
Columns show predicted population changes for each basin country combination.
The backgrouund shading follows a gradient from Near Threatened (-0.2 / 20% loss) to 
Critically Endangered (-0.8, 80% loss). 
The width of columns is proportional to the river length on a log scale 
(labels show river lengths in thousands of kilometers).
